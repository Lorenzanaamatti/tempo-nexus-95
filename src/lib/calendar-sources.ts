...
export const EXTRA_KIND_LABELS = {
  ...
  preparacion_estreno: "Preparación comunicado estreno",
  nominacion: "Nominación",
  comunicado_nominacion: "Comunicado nominación",
  preparacion_nominacion: "Preparación comunicado nominación",
  premio: "Premio",
  comunicado_premio: "Comunicado premio",
  preparacion_premio: "Preparación comunicado premio",
} as const;
...
export const KIND_FAMILY: Record<string, CalendarSource> = {
  ...
  estreno: "productions",
  entrega: "productions",
  comunicado_estreno: "productions",
  preparacion_estreno: "productions",
  nominacion: "productions",
  comunicado_nominacion: "productions",
  preparacion_nominacion: "productions",
  premio: "productions",
  comunicado_premio: "productions",
  preparacion_premio: "productions",
  facturacion: "billing",
  pago: "billing",
  cobro: "billing",
...
export const KIND_BAR_ALL: Record<string, string> = {
  ...
  comunicado_estreno: "bg-violet-600/85 border-violet-800/50 text-violet-50",
  preparacion_estreno: "bg-violet-300/60 border-violet-500/40 text-violet-950",
  nominacion: "bg-fuchsia-600/85 border-fuchsia-800/50 text-fuchsia-50",
  comunicado_nominacion: "bg-fuchsia-500/80 border-fuchsia-700/50 text-fuchsia-50",
  preparacion_nominacion: "bg-fuchsia-300/60 border-fuchsia-500/40 text-fuchsia-950",
  premio: "bg-purple-700/90 border-purple-900/50 text-purple-50",
  comunicado_premio: "bg-purple-500/80 border-purple-700/50 text-purple-50",
  preparacion_premio: "bg-purple-300/60 border-purple-500/40 text-purple-950",
  // billing — amber
