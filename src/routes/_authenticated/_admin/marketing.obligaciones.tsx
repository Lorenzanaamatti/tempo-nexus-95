...
function StubPage() {
  return (
    <div className="mx-auto max-w-[1400px] px-6 py-10">
      ...
      <h1 className="mt-2 font-display text-5xl font-extrabold title-caps">Obligaciones de marketing</h1>
      <p className="mt-3 max-w-2xl text-sm text-muted-foreground">
        Compromisos de marketing vinculados a contratos y producciones.
      </p>
      <div className="mt-10">
