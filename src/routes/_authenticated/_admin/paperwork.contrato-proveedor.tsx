...
export const Route = createFileRoute("/_authenticated/_admin/paperwork/contrato-proveedor")({
  component: StubPage,
});
...
function StubPage() {
  return (
    <div className="mx-auto max-w-[1400px] px-6 py-10">
      ...
      <h1 className="mt-2 font-display text-5xl font-extrabold title-caps">Contratos de proveedor</h1>
